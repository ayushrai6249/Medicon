...
const Appointment = () => {
  ...
  const getAvailableSlots = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      setDocSlot((prev) => { return [...prev, timeSlots] });
    }
  };
  ...
  return docInfo && (
    <div>
      <div className='flex flex-col sm:flex-row gap-4'>
        <div>
          <img className='bg-secondary w-full rounded sm:max-w-72' src={docInfo.image} alt="" />
        </div>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        <p>Booking slots</p>
        <div className='flex gap-3 item-center w-full overflow-x-scroll'>
          {
